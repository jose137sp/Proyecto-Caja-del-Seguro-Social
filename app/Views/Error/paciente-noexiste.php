...
<body>
    ...
    <div class="container-fluid">
        <div class="jumbotron text-center">
            <h4 class="display-4">¡Datos de paciente incorrectos!</h4>
            <br>
            <br>
            <p class="lead">
                <a class="btn" href="?controller=Paciente&&action=consultar_cita" role="button" style="background-color: #0053a3; color: white;">Regresar</a>
            </p>
            <br><br>
            <hr>
            <p>
